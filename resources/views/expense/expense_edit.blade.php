        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <form action="{{ URL('/ExpenseUpdate') }}" method="post">
                    ...
                    <input type="hidden" name="ExpenseMasterID" value="{{ $expense_master->ExpenseMasterID }}">
                        ...
                        <div class="card-body">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="SupplierID" id="SupplierID" class="form-select select2 mt-5"
                                                ...
                                                <option value="{{ $value->SupplierID }}"
                                                    {{ $value->SupplierID == $expense_master->SupplierID ? 'selected=selected' : '' }}>
                                            ...
                                            <select name="ChartOfAccountID_From" id="ChartOfAccountID_From"
                                                ...
                                                @foreach ($chartofaccount as $key => $value)
                                                    <option value="{{ $value->ChartOfAccountID }}"
                                                        {{ $value->ChartOfAccountID == $expense_master->ChartOfAccountID ? 'selected=selected' : '' }}>
                                        ...
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="ReferenceNo" autocomplete="off"
                                                    class="form-control" value="{{ $expense_master->ReferenceNo }}">
                                        ...
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-9">
                                                <div id="invoict_type"> <input type="text" name="ExpenseNo"
                                                        ...
                                                        value="{{ $expense_master->ExpenseNo }}" readonly=""></div>
                                                ...
                                                <tr class="p-3">
                                                    ...
                                                    <td>
                                                        ...
                                                        <select name="ItemID0[]" id="ItemID0_{{ $no }}"
                                                            ...
                                                            @foreach ($chartofaccount as $key => $value)
                                                                <option value="{{ $value->ChartOfAccountID }}"
                                                                    {{ $value->ChartOfAccountID == $value1->ChartOfAccountID ? 'selected=selected' : '' }}>
                                                                    {{ $value->ChartOfAccountID }}-{{ $value->ChartOfAccountName }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                        <input type="hidden" name="ChartOfAccountID[]"
                                                            id="ItemID_{{ $no }}"
                                                            value="{{ $value1->ChartOfAccountID }}">
                                                    </td>
                                                    ...
                                                    <td>
                                                        <select name="Tax[]" id="TaxID_{{ $no }}"
                                                            class="form-select changesNo tax exclusive_cal"
                                                            required="">
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-lg-8 col-12  ">
                                    ...
                                    <iframe src="{{ URL('/Attachment') }}" width="100%" height="100%" border="0"
                                        ...
                                        <div class="form-group mt-1">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="grandtotaltax"
                                                    ...
                                                    onkeypress="return IsNumeric(event);" ondrop="return false;"
                                                    onpaste="return false;" value="{{ $expense_master->Tax }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mt-1">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" name="Grandtotal" class="form-control"
                                                    ...
                                                    onkeypress="return IsNumeric(event);" ondrop="return false;"
                                                    onpaste="return false;" value="{{ $expense_master->GrantTotal }}">
                                            </div>
                                        </div>
    ...
    <script>
        ...
        $(".addmore").on('click', function() {
            ...
            html += '<td><select name="ItemID0[]" id="ItemID0_' + i +
                ...
                i +
                ');" > <option value="">select</option>}@foreach ($chartofaccount as $key => $value) <option value="{{ $value->ChartOfAccountID }}|{{ $value->ChartOfAccountName }}">{{ $value->ChartOfAccountName }}</option>@endforeach</select><input type="hidden" name="ChartOfAccountID[]" id="ItemID_' +
                i + '"></td>';
