...
@section('content')
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ URL('/ExpenseReport1') }}" method="post" name="form1" id="form1">
                                    {{ csrf_field() }}
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group" id="datepicker21">
                                            <input type="text" name="StartDate" autocomplete="off" class="form-control"
                                                ...
                                                container="#datepicker21" data-provide="datepicker"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group" id="datepicker22">
                                            <input type="text" name="EndDate" autocomplete="off" class="form-control"
                                                placeholder="yyyy-mm-dd" data-date-format="yyyy-mm-dd" data-date-
                                                container="#datepicker22" data-provide="datepicker"
                                                data-date-autoclose="true" value="{{ date('Y-m-d') }}">
                                            <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
                                        </div>
                                    </div>
                            ...
                            <div class="card-footer bg-light">
                                <button type="button" class="btn btn-success w-lg float-right"
                                    id="online">Submit</button>
                            <button type="button" class="btn btn-primary w-lg float-right" id="pdf_submit">PDF</button>
                                {{-- <a href="{{ URL('create-voucher') }}" class="btn btn-secondary w-lg float-right">Cancel</a> --}}
                            </div>
                        </div>
                        </form>
                    </div>
    ...
    <script>
        $('#pdf_submit').click(function() {
            $('#form1').attr('action', '{{ URL('/ExpenseReportPDF') }}');
