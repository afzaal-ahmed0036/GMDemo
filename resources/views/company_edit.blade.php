                        ...
                        <form action="{{ URL('/CompanyUpdate') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div>
                                <div>
                                    ...
                                    <div class="mb-1 row">
                                        <label for="example-email-input" class="col-md-3 col-form-label fw-bold ">Company
                                            Name</label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="mb-1 row">
                                        <label for="example-email-input"
                                            class="col-md-3 col-form-label fw-bold text-danger"> Company Name (Extra Line)
                                        </label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="mb-1 row">
                                        <label for="example-email-input"
                                            class="col-md-3 col-form-label fw-bold text-danger">TRN # </label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="mb-2 row">
                                        <label for="example-url-input"
                                            class="col-md-3 col-form-label fw-bold">Website</label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="mb-2 row">
                                        <label for="example-url-input"
                                            class="col-md-3 col-form-label fw-bold">Address</label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="mb-2 row">
                                        <label for="example-url-input"
                                            class="col-md-3 col-form-label fw-bold">BackgroundLogo</label>
                                        <div class="col-md-6">

                                            <input class="form-control" type="file" name="BackgroundLogo"
                                                id="BackgroundLogo" value="{{ $BackgroundLogo }}">
                                        </div>
                                    ...
                                    <div class="mb-2 row">
                                        <label for="example-url-input"
                                            class="col-md-3 col-form-label fw-bold">Signature</label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="mb-2 row">
                                        <label for="example-url-input" class="col-md-3 col-form-label fw-bold">Digital
                                            Signature</label>
                                        <div class="col-md-6">

                                            <textarea name="DigitalSignature" id="DigitalSignature" cols="30" rows="10">{{ $DigitalSignature }}</textarea>
                                    ...
                                    <div class="mb-2 row">
                                        <label for="example-url-input"
                                            class="col-md-3 col-form-label fw-bold">EstimateInvoiceTitle</label>
                                        <div class="col-md-6">
                                            <input class="form-control" type="text" name="EstimateInvoiceTitle"
                                                value="{{ $EstimateInvoiceTitle }}">
                                        </div>
                                    ...
                                    <div class="mb-2 row">
                                        <label for="example-url-input"
                                            class="col-md-3 col-form-label fw-bold">SaleInvoiceTitle</label>
                                        <div class="col-md-6">
                                            <input class="form-control" type="text" name="SaleInvoiceTitle"
                                                value="{{ $SaleInvoiceTitle }}">
                                        </div>
                                    ...
                                    <div class="mb-2 row">
                                        <label for="example-url-input"
                                            class="col-md-3 col-form-label fw-bold">DeliveryChallanTitle</label>
                                        <div class="col-md-6">
                                            <input class="form-control" type="text" name="DeliveryChallanTitle"
                                                value="{{ $DeliveryChallanTitle }}">
                                        </div>
                                    ...
                                    <div class="mb-2 row">
                                        <label for="example-url-input"
                                            class="col-md-3 col-form-label fw-bold">CreditNoteTitle</label>
                                        <div class="col-md-6">
                                            <input class="form-control" type="text" name="CreditNoteTitle"
                                    ...
                                    <div class="mb-2 row">
                                        <label for="example-url-input"
                                            class="col-md-3 col-form-label fw-bold">PurchaseInvoiceTitle</label>
                                        <div class="col-md-6">
                                            <input class="form-control" type="text" name="PurchaseInvoiceTitle"
                                                value="{{ $PurchaseInvoiceTitle }}">
                                        </div>
                                    ...
                                    <div class="mb-2 row">
                                        <label for="example-url-input"
                                            class="col-md-3 col-form-label fw-bold">DebitNoteTitle</label>
                                        <div class="col-md-6">
                                            <input class="form-control" type="text" name="DebitNoteTitle"
                                                value="{{ $DebitNoteTitle }}">
                                        </div>
