    ...
    <div class="main-content">
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="card">
                    <form action="{{ URL('/SaleReport1') }}" method="post" name="form1" id="form1">
                        <div class="card-body">
                        ...
                        <div class="card-footer bg-light">
                            ...
                            {{-- <button type="button" class="btn btn-secondary w-lg float-right" id="csv_submit">Export</button> --}}
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#pdf_submit").click(function() {
                $("#form1").attr("action", "{{ URL('/saleReportPDF') }}");
                $('#form1').attr('target', '_blank');
                $('#form1').submit();
                // Submit the form when the "PDF" button is clicked
            });
            $("#online").click(function() {
                $("#form1").attr("action", "{{ URL('/SaleReport1') }}");
                // $('#form1').attr('target', '_blank');
                $('#form1').submit();
                // Submit the form when the "PDF" button is clicked
            });
