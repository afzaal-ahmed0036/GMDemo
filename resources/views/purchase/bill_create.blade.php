                    ...
                    <div class="card shadow-sm">
                        <div class="card-body">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="SupplierID" id="SupplierID" class="form-select select2 mt-5"
                                                ...
                                                <option value="{{ $value->SupplierID }}"
                                                    {{ old('SupplierID') == $value->SupplierID ? 'selected' : '' }}>
                                        ...
                                        <div class="col-sm-9">
                                            <select name="UserID" id="UserID" class="form-select">
                                                ...
                                                <option value="{{ $value->UserID }}"
                                                    {{ old('UserID') == $value->UserID ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input readonly type="text" name="InvoiceNo" autocomplete="off"
                            ...
                            <div class='text-center mb-2'>
                                <strong class="text-info"><span class="text-dark">Note:</span> When selecting an item, the
                                    values displayed in the Rate and Selling Price columns
                                    correspond to the prices at which you previously purchased that item.</strong>
                            </div>
                            {{-- <div class='text-center mb-2' style="direction: rtl">
                                <strong class="text-info"><span class="text-dark">ملحوظة:</span>
                                    عند تحديد عنصر ما، تتوافق القيم المعروضة في عمودي السعر وسعر البيع مع الأسعار التي اشتريت بها هذا العنصر مسبقًا
                                </strong>
                            </div> --}}
                            <div class='row'>
                                    ...
                                    <table>
                                        <thead>
                                            <tr class="bg-light borde-1 border-light " style="height: 40px;">
                                                <th width="2%" class="text-center"><input id="check_all"k
                                                        type="checkbox" /></th>
                                        ...
                                        <tbody>
                                            <tr class="p-3">
                                                ...
                                                <td>
                                                    <input required type="number" name="Qty[]" id="Qty_1"
                                                        class=" form-control changesNo" autocomplete="off"
                                                        onkeypress="return IsNumeric(event);" ondrop="return false;"
                                                        onpaste="return false;" step="1" value="1">
                                                </td>

                                                <td>
                                                    <input required type="number" name="Price[]" id="Price_1"
                                                        class=" form-control changesNo" autocomplete="off"
                                                        onkeypress="return IsNumeric(event);" ondrop="return false;"
                                                ...
                                                <td class="d-none">
                                                    <select name="Tax[]" id="TaxID_1"
                                                        class="form-control changesNo tax exclusive_cal" required="">
                                                        <?php foreach ($tax as $key => $valueX1) : ?>
                                    ...
                                    <form class="form-inline">
                                        ...
                                        <div class="form-group mt-1">
                                            ...
                                            <div class="input-group">
                                                <span
                                                    class="input-group-text bg-light">{{ session::get('Currency') }}</span>
                                                <input required type="number" class="form-control" id="amountPaid"
                                                    name="amountPaid" placeholder="Amount Paid"
                                                    onkeypress="return IsNumeric(event);" ondrop="return false;"
                                                    onpaste="return false;" step="0.01" value="">
                                            </div>
                                        </div>
                                        <div class="form-group mt-1">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control amountDue" name="amountDue"
                                                    ...
                                                    onkeypress="return IsNumeric(event);" ondrop="return false;"
                                                    onpaste="return false;" step="0.01" readonly>
                                            </div>
                                        </div>
                                </div>
                            </div>
...
@push('after-scripts')
    <script>
        ...
        $(".addmore").on('click', function() {
            ...
            html += '<td><select required name="ItemID0[]" id="ItemID0_' + i +
                '"  style="width: 300px !important;" class="form-select select2 changesNoo" onchange="km(this.value,' +
                i +
                ');" > <option value="">select</option>}@foreach ($items as $key => $value) <option value="{{ $value->ItemID }}|{{ $value->Percentage }}">{{ $value->ItemCode }}-{{ $value->ItemName }}</option>@endforeach</select><input type="hidden" name="ItemID[]" id="ItemID_' +
                i + '"></td>';

            html += '  <td><input type="text" name="Description[]" id="Description_' + i +
                '" class=" form-control " ></td>';
            html += '<td><input required type="text" name="Qty[]" id="Qty_' + i +
            ...
            html += '<td><input required type="text" name="Price[]" id="Price_' + i +
            ...
            html += '<td class="d-none">><select required name="Tax[]" id="TaxID_' + i +
        ...
        function km(v, id) {
            ...
            $('#sellingPrice_' + id[1]).val(json["SellingPrice"]);

            $('#TaxVal_' + id[1]).val(((parseFloat(json["Percentage"])) / 100) * (parseFloat(json["SellingPrice"])));

            $('#ItemTotal_' + id[1]).val(((parseFloat(json["CostPrice"]) * parseFloat($('#Qty_' + id[1]).val())) + (((
                parseFloat(json["Percentage"])) / 100) * (parseFloat(json["CostPrice"])))).toFixed(2));
