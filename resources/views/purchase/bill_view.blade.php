                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-print-block d-sm-flex align-items-center justify-content-between">
                            ...
                            <a href="{{ URL('/Bill') }}" class="btn btn-primary w-md float-right ">Back</a>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="vertical-align: top; text-align:right;width:50%;">
                                            ...
                                            <b>BILL # {{ $invoice_master->InvoiceNo }}</b></span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                            ...
                                            <div style="clear:both;width:50%;margin-top: 20px;">
                                                ...
                                                <span style="white-space: pre-wrap;" id="tmp_shipping_address"><strong><span
                                                            class="pcs-customer-name" id="zb-pdf-customer-detail"><a
                                                                href="#">{{ $invoice_master->SupplierID == 1 ? $invoice_master->WalkinCustomerName : $invoice_master->SupplierName }}</a></span></strong><br>
                                                    TRN # {{ $invoice_master->TRN }},<br>
                                                    {{ $invoice_master->Address }}
                                                    {{ $invoice_master->Phone }}
                                                    {{ $invoice_master->Email }}
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-align:right;">
                                                            <span
                                                                id="tmp_entity_date">{{ dMY($invoice_master->Date) }}</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td
                                                        ...
                                                        <td style="text-align:right;">
                                                            <span
                                                                id="tmp_ref_number">{{ dMY($invoice_master->DueDate) }}</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td
                                                            style="text-align:right;padding:5px 10px 5px 0px;font-size: 10pt;">
                                                            <span class="pcs-label">Ref (L.P.O) # :</span>
                                                        </td>
                                                        <td style="text-align:right;">
                                                            <span
                                                                id="tmp_ref_number">{{ $invoice_master->ReferenceNo }}</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td
                                                            style="text-align:right;padding:5px 10px 5px 0px;font-size: 10pt;">
                                                            <span class="pcs-label">Payment Mode :</span>
                                                        </td>
                                                        <td style="text-align:right;">
                                                            <span id="tmp_ref_number">{{ $invoice_master->PaymentMode }}
                                                                - {{ $invoice_master->PaymentDetails }}</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td
                            ...
                            <table style="width:100%;margin-top:20px;table-layout:fixed;" class="pcs-itemtable"
                                ...
                                <thead>
                                    <tr style="height:32px;">
                                        ...
                                        <td bgcolor="#CCCCCC" class="pcs-itemtable-breakword pcs-itemtable-header"
                                            id=""
                                            style="padding: 5px 10px 5px 5px;width: 120px;text-align: right;"><strong>
                                                Amount </strong></td>
                                    </tr>
                                </thead>
                                ...
                                <div style="width: 45%;padding: 3px 10px 3px 3px;font-size: 9pt;float: left;">
                                    <div style="white-space: pre-wrap;">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td>
                                                    <div align="left">{{ $invoice_master->CustomerNotes }} </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div align="left">{{ $invoice_master->DescriptionNotes }} </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="pcs-balance">
                                                ...
                                                <td width="289" height="25" align="right" valign="middle"
                                                    ...
                                                    <div align="right"><b>{{ $invoice_master->Total }}</b></div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr class="pcs-balance">
                                                ...
                                                <td height="25" align="right" valign="middle" id="tmp_total"
                                                    ...
                                                    <div align="right"><b>{{ $invoice_master->TaxPer }}</b></div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr class="pcs-balance">
                                                ...
                                                <td height="25" align="right" valign="middle" id="tmp_total"
                                                    style="width:120px;;padding: 10px 10px 10px 5px;">
                                                    <div align="right"><b>{{ $invoice_master->Tax }}</b></div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr class="pcs-balance">
                                                ...
                                                <td height="25" align="right" valign="middle" id="tmp_total"
                                                    style="width:120px;;padding: 10px 10px 10px 5px;">
                                                    <div align="right"><b>{{ $invoice_master->DiscountPer }}</b></div>
                                                </td>
                                            </tr>
                                            <tr class="pcs-balance">
                                                <td height="25" align="right" valign="middle"><b>Discount</b></td>
                                                <td height="25" align="right" valign="middle" id="tmp_total"
                                                    style="width:120px;;padding: 10px 10px 10px 5px;">
                                                    <div align="right"><b>{{ $invoice_master->DiscountAmount }}</b>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr class="pcs-balance">
                                                ...
                                                <td height="25" align="right" valign="middle" id="tmp_total"
                                                    style="width:120px;;padding: 10px 10px 10px 5px;">
                                                    <div align="right"><b>{{ $invoice_master->Shipping }}</b></div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr class="pcs-balance">
                                                ...
                                                <td height="25" align="right" valign="middle" id="tmp_total"
                                                    style="width:120px;;padding: 10px 10px 10px 5px;">
                                                    <div align="right"><b>{{ $invoice_master->GrandTotal }}</b></div>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
